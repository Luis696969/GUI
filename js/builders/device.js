...
import { buildChemicals } from './chemical.js';
import { buildCells } from './cell.js';
import { buildEntries } from './entry.js';
import { buildReactions } from './reaction.js';
...
export function buildDevices(dom, warnings) {
  ...
  const devices = deviceEls.map((deviceEl, index) => {
    ...
    const device = { id, domain, entries, chemicals, cells, reactions };
